...
function Popup({ onClose, yesSure, content }) {
  ...
  return (
    <div className={`bg-gray-400 rounded-md shadow-xl antialiased ${isShaking ? 'animate-shake' : ''} absolute top-0 phone:top-3 md:-top-3 bg-opacity-50 border border-primary flex items-center justify-center max-w-[80%]`}>
      <div className="bg-primary p-8 rounded-md">
        ...
        <h2 className="text-2xl font-bold mb-4 text-black z-50">{content === 'Thank God !' ? <span className='max-w-[10%]'>True love wait cheyyerkum lleh.</span> : ''}</h2>
